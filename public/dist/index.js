...
function flipBackUnPairedCards() {
    var cards = document.querySelectorAll(".game__containerGame__card");
...
function hideCards() {
    var deck = document.querySelector(".game__containerGame");
...
var handleRestartGame = function () {
    try {
        var winningMessage = document.querySelector("#winningMessage");
        document.querySelector(".game__titleGame").style.display = "block";
...
function winMessage() {
    var winningMessage = document.querySelector("#winningMessage");
    document.querySelector(".game__titleGame").style.display = "none";
...
function pulseLogin() {
    setInterval(function () {
        setTimeout(function () {
            document.querySelector(".loginPageContainer__title__smilyImg").style.transform = "scale(1.5)";
            document.querySelector(".loginPageContainer__title__smilyImg").style.transition = "all 4s ease";
        }, 4000);
        setTimeout(function () {
            document.querySelector(".loginPageContainer__title__smilyImg").style.transform = "scale(1.0)";
            document.querySelector(".loginPageContainer__title__smilyImg").style.transition = "all 4s ease";
        }, 6000);
    }, 15000);
}
function pulseGame() {
    setInterval(function () {
        setTimeout(function () {
            document.querySelector(".game__titleGame__smilyImgGame").style.transform = "scale(1.5)";
            document.querySelector(".game__titleGame__smilyImgGame").style.transition = "all 4s ease";
        }, 4000);
        setTimeout(function () {
            document.querySelector(".game__titleGame__smilyImgGame").style.transform = "scale(1.0)";
            document.querySelector(".game__titleGame__smilyImgGame").style.transition = "all 4s ease";
        }, 6000);
    }, 15000);
}
function pulseStatistic() {
    setInterval(function () {
        setTimeout(function () {
            document.querySelector(".generalStatisticContainer__title__smilyImgStatistic").style.transform = "scale(1.5)";
            document.querySelector(".generalStatisticContainer__title__smilyImgStatistic").style.transition = "all 4s ease";
        }, 4000);
        setTimeout(function () {
            document.querySelector(".generalStatisticContainer__title__smilyImgStatistic").style.transform = "scale(1.0)";
            document.querySelector(".generalStatisticContainer__title__smilyImgStatistic").style.transition = "all 4s ease";
        }, 6000);
    }, 12000);
}
